      ...
      <div class="container">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <Link to={`/edit/${this.props.match.params.id}`} class="btn btn-success">Edit</Link>&nbsp;
            <button onClick={this.delete.bind(this, this.props.match.params.id)} class="btn btn-danger">Delete</button>
          </div>
        </div>
      </div>
    );
